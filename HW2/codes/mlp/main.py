...
if __name__ == '__main__':
	...
	if args.is_train:
		...
		for epoch in range(1, args.num_epochs+1):
			...
			# writer.add_scalars(f'train_loss', {f'mlpWD_{args.batch_size}_{args.learning_rate}_{args.drop_rate}': train_loss}, epoch)
			# writer.add_scalars(f'train_acc', {f'mlpWD_{args.batch_size}_{args.learning_rate}_{args.drop_rate}': train_acc}, epoch)
			val_acc, val_loss = valid_epoch(mlp_model, X_val, y_val)
			# writer.add_scalars(f'val_loss', {f'mlpWD_{args.batch_size}_{args.learning_rate}_{args.drop_rate}': val_loss}, epoch)
			# writer.add_scalars(f'val_acc', {f'mlpWD_{args.batch_size}_{args.learning_rate}_{args.drop_rate}': val_acc}, epoch)
